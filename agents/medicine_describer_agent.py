...
class MedicineDescriberAgent:
    async def identify_and_describe_medicine(self, medecineImage, filename):
        file_bytes = await medecineImage.read()
        img_base64 = base64.b64encode(file_bytes).decode("utf-8")
        filename_lower = filename.lower()
        print(f"zaeaea{filename_lower}")
        if filename_lower.endswith(".png"):
            ...
            raise ValueError("Unsupported image type. Please use PNG, JPG, or WEBP.")
